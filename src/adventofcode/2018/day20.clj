...
(def mem-move-once (memoize move-once))


(defn move
  "=> [door-xy next-xy]"
  [xy dir]
  [(-> xy (mem-move-once dir))
   (-> xy (mem-move-once dir)
          (mem-move-once dir))])

(def mem-move (memoize move))
